...
public class HomeIconAdapter extends BaseAdapter {
    ...
    // references to icons
    private final Integer[] mIcons = { R.drawable.icon_profile, R.drawable.icon_news,
	    R.drawable.icon_tour, R.drawable.icon_emergency,
	    R.drawable.icon_schedule, R.drawable.icon_addressbook,
	    R.drawable.icon_courses };

    // references to icons labels
    private final String[] mIconsLabels = { "Profil", "Nouvelles", "Tour guidé",
	    "Sécurité", "Horaire", "Bottin", "Mes cours" };
}
