...
public class AppEtsOpenHelper extends SQLiteOpenHelper {
    ...
    // private static final String DB_CREATE_FEED_TABLE =
    // "CREATE TABLE channel( _id INTEGER PRIMARY KEY AUTOINCREMENT, channel_id INTEGER, name TEXT, link TEXT, type TEXT, image TEXT, lang TEXT)";
