...
public class ChannelsDbAdapter extends BaseDbAdapter {
	...
	return db.delete(ChannelsDbAdapter.TABLE_NAME,
	...
	final Cursor mCursor = db.query(true, ChannelsDbAdapter.TABLE_NAME,
		new String[] { ChannelsDbAdapter.KEY_ROWID,
			ChannelsDbAdapter.KEY_NAME, ChannelsDbAdapter.KEY_URL,
			ChannelsDbAdapter.KEY_IMAGE },
		ChannelsDbAdapter.KEY_ROWID + "=" + rowId, null, null, null,
		null, null);
	if (mCursor != null) {
	    mCursor.moveToFirst();
	}
	...
	return db.query(ChannelsDbAdapter.TABLE_NAME, new String[] {
		...
		ChannelsDbAdapter.KEY_URL, ChannelsDbAdapter.KEY_IMAGE }, null,
		null, null, null, null);
    }
