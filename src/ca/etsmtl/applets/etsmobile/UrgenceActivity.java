...
public class UrgenceActivity extends Activity {
	...
	for (final String filename : files) {
		...
		if (!f.exists()) {
		    ...
		    out = new FileOutputStream(UrgenceActivity.SDCARD + "/" + filename);
		    copyFile(in, out);
		    in.close();
		    in = null;
		    out.flush();
	...
	findViewById(R.id.urgence_appel_urgence).setOnClickListener(new OnClickListener() {

	    @Override
	    public void onClick(final View v) {
		final String uri = "tel:" + getString(R.string.secu_phone_lbl);
