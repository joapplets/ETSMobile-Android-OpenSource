...
public class ETSMobileContentProvider extends android.content.ContentProvider {
    ...
    public static final Uri CONTENT_URI_NEWS = Uri.parse("content://"
	    + ETSMobileContentProvider.AUTHORITY + "/" + ETSMobileContentProvider.NEWS_PATH);
    ...
    public static final Uri CONTENT_URI_BOTTIN = Uri.parse("content://"
	    + ETSMobileContentProvider.AUTHORITY + "/" + ETSMobileContentProvider.BOTTIN_PATH);
    ...
    public static final Uri CONTENT_URI_SESSION = Uri.parse("content://"
	    + ETSMobileContentProvider.AUTHORITY + "/" + ETSMobileContentProvider.SESSION_PATH);
     ...
     * Activity Calendar
     */
    public static final Uri CONTENT_URI_ACTIVITY_CALENDAR = Uri.parse("content://"
	    + ETSMobileContentProvider.AUTHORITY + "/" + ETSMobileContentProvider.ACT_PATH);
    // --> cursor.dir/act
    ...
    public static final Uri CONTENT_URI_JOURS_REMPLACE = Uri.parse("content://"
	    + ETSMobileContentProvider.AUTHORITY + "/" + ETSMobileContentProvider.JOUR_PATH);
	...
	ETSMobileContentProvider.sURIMatcher.addURI(ETSMobileContentProvider.AUTHORITY,
		ETSMobileContentProvider.NEWS_PATH, ETSMobileContentProvider.ALL_NEWS);

	// --> ca.etsmtl.applets.etsmobile - news/* - 2
	ETSMobileContentProvider.sURIMatcher.addURI(ETSMobileContentProvider.AUTHORITY,
		ETSMobileContentProvider.NEWS_PATH + "/#", ETSMobileContentProvider.SINGLE_NEWS);

	// --> ca.etsmtl.applets.etsmobile - bottin - 3
	ETSMobileContentProvider.sURIMatcher.addURI(ETSMobileContentProvider.AUTHORITY,
		ETSMobileContentProvider.BOTTIN_PATH, ETSMobileContentProvider.ALL_BOTTIN);

	// --> ca.etsmtl.applets.etsmobile - bottin/* - 4
	ETSMobileContentProvider.sURIMatcher
		.addURI(ETSMobileContentProvider.AUTHORITY, ETSMobileContentProvider.BOTTIN_PATH
			+ "/#", ETSMobileContentProvider.SINGLE_BOTTIN);

	// --> ca.etsmtl.applets.etsmobile - session - 5
	ETSMobileContentProvider.sURIMatcher.addURI(ETSMobileContentProvider.AUTHORITY,
		ETSMobileContentProvider.SESSION_PATH, ETSMobileContentProvider.ALL_SESSION);
	...
	ETSMobileContentProvider.sURIMatcher.addURI(ETSMobileContentProvider.AUTHORITY,
		ETSMobileContentProvider.ACT_PATH, ETSMobileContentProvider.ALL_ACT);

	// --> ca.etsmtl.applets.etsmobile - session/* - 8
	ETSMobileContentProvider.sURIMatcher.addURI(ETSMobileContentProvider.AUTHORITY,
		ETSMobileContentProvider.ACT_PATH + "/#", ETSMobileContentProvider.SINGLE_ACT);

	// --> ca.etsmtl.applets.etsmobile - session - 9
	ETSMobileContentProvider.sURIMatcher.addURI(ETSMobileContentProvider.AUTHORITY,
		ETSMobileContentProvider.JOUR_PATH, ETSMobileContentProvider.ALL_JOUR);

	// --> ca.etsmtl.applets.etsmobile - session/* - 10
	ETSMobileContentProvider.sURIMatcher.addURI(ETSMobileContentProvider.AUTHORITY,
		ETSMobileContentProvider.JOUR_PATH + "/#", ETSMobileContentProvider.SINGLE_JOUR);
    }

    private ETSMobileOpenHelper helper;

    private void buildBottinQuerySingle(final Uri uri, final SQLiteQueryBuilder queryBuilder) {
	queryBuilder.appendWhere(BottinTableHelper.BOTTIN__ID + "=" + uri.getLastPathSegment());
    }
    ...
    private void buildNewsQuerySingle(final Uri uri, final SQLiteQueryBuilder queryBuilder) {
	queryBuilder.appendWhere(NewsTableHelper.NEWS_ID + "=" + uri.getLastPathSegment());
    }
    ...
    @Override
    public Cursor query(final Uri uri, final String[] columns, String selection,
	...
	try {
	    ...
	    if (db.isOpen()) {
		cursor = queryBuilder.query(db, columns, selection, selectionArgs, null, null,
			sortOrder);
	...
	if (columns != null) {
	    final HashSet<String> requestedColumns = new HashSet<String>(Arrays.asList(columns));

	    HashSet<String> availableColumns = null;
	    if (path.contains(ETSMobileContentProvider.NEWS_PATH)) {
		availableColumns = new HashSet<String>(Arrays.asList(NewsTableHelper.AVAILABLE));
	    } else {
		availableColumns = new HashSet<String>(Arrays.asList(BottinTableHelper.AVAILABLE));
	    }
