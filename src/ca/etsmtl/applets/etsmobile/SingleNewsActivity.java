...
public class SingleNewsActivity extends Activity {
	...
	final String[] projection = { NewsTableHelper.NEWS_DATE, NewsTableHelper.NEWS_TITLE,
		NewsTableHelper.NEWS_DESCRIPTION, NewsTableHelper.NEWS_SOURCE,
		NewsTableHelper.NEWS_LINK };
	final Cursor c = managedQuery(
		Uri.withAppendedPath(ETSMobileContentProvider.CONTENT_URI_NEWS, String.valueOf(id)),
	...
	if (webView == null) {
	    ...
	    webView.setLayoutParams(new ViewGroup.LayoutParams(LayoutParams.FILL_PARENT,
		...
		public void onProgressChanged(final WebView view, final int progress) {
		    if (SingleNewsActivity.progressDialog != null && progress == 100
			    && SingleNewsActivity.progressDialog.isShowing()) {
		...
		html = doc.html();
		html = "<h2>" + title + "</h2><br>" + date
			+ "<hr width=\"98%\" size=\"2\" align=\"center\"><br>" + html;
	...
	SingleNewsActivity.progressDialog = new ProgressDialog(SingleNewsActivity.this);
	SingleNewsActivity.progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
