...
public class ProfileActivity extends Activity implements OnClickListener, OnDismissListener,
	...
	case 2:
	    ...
	    break;
	case 3:
	    ((TextView) view.findViewById(R.id.textView1)).setText(R.string.bandwith_dialog_rez);
	    ((TextView) view.findViewById(R.id.textView2)).setText(R.string.bandwith_dialog_appt);
