...
public class ActivityCalendarTableHelper {
	...
	public static final String[] AVAILABLE = new String[] {
			...
			ActivityCalendarTableHelper.ACTIVITY_JOUR, ACTIVITY_JOURNEE,
			ACTIVITY_CODE, ACTIVITY_COURS, ACTIVITY_TITRE, ACTIVITY_GROUP,
			ACTIVITY_EVENT_DRAW_ID, ACTIVITY_SESSION_ID };
