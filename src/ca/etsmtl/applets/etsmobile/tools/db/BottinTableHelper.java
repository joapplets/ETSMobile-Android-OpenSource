...
public class BottinTableHelper {
	...
	public static final String[] AVAILABLE = new String[] {
			...
			BottinTableHelper.BOTTIN_PRENOM, BottinTableHelper.BOTTIN_COURRIEL,
			BottinTableHelper.BOTTIN_EMPLACEMENT,
			BottinTableHelper.BOTTIN_TELBUREAU,
