...
public class ScheduleActivity extends Activity {
	...
	public void slideUp()
	{
		...
		//�viter d'avoir le OnCellTouchListener de la grille1 par dessus la grille 3 (superposition)
	 ...
	 * les param�tre d'affichage de session
	 */
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		//Affiche la liste des �v�nements d'aujourd'hui
