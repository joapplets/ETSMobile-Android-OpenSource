...
public class NewsService extends Service implements Observer {
	...
	getContentResolver()
		.insert(ETSMobileContentProvider.CONTENT_URI_NEWS, n.getContentValues());
	getSharedPreferences("dbpref", Context.MODE_PRIVATE).edit().putBoolean("isEmpty", false)
		.commit();
    }
    ...
    private void updateLink(final News news, final String old, final String updated) {
