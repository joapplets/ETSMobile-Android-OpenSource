...
public class BottinEntry extends Model {
    ...
    public BottinEntry(final long id, final String nom, final String prenom,
	    final String telBureau, final String emplacement, final String courriel,
	    final String service, final String titre, final Date date_modif) {
	super();
	uuid = id;
	this.nom = nom;
	this.prenom = prenom;
    ...
    public BottinEntry(final String id2, final String nom2, final String prenom2,
	    final String tel_bureau, final String emplacement2, final String courriel,
	    final String service2, final String titre2, final Date date_modif2) {

	this(-1, nom2, prenom2, tel_bureau, emplacement2, courriel, service2, titre2, date_modif2);
	ets_id = id2;
    }
	...
	cv.put(BottinTableHelper.BOTTIN_TELBUREAU, telBureau == null ? "" : telBureau);
	cv.put(BottinTableHelper.BOTTIN_EMPLACEMENT, emplacement == null ? "" : emplacement);
	cv.put(BottinTableHelper.BOTTIN_COURRIEL, courriel == null ? "" : courriel);
