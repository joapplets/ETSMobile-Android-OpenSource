...
public class Session implements Serializable, Comparable<Session> {
	...
	public Session(Cursor mCursor) {
		...
		longName = mCursor.getString(mCursor
				.getColumnIndex(SessionTableHelper.SESSIONS_LONG_NAME));
		...
		maxActivities = mCursor.getInt(mCursor
				.getColumnIndex(SessionTableHelper.SESSIONS_MAX_ACT));
		user_id = mCursor.getString(mCursor
				.getColumnIndex(SessionTableHelper.SESSIONS_USER_ID));
