...
public class ActivityCalendar implements Comparable<ActivityCalendar> {
	...
	public ActivityCalendar(String cours, String startDate, String endDate,
			String titreCours, String name, String groupe, String codeActivite,
			String jour, String journee, String location, int eventDrawableResId) {
		this.cours = cours;
	...
	public ActivityCalendar(Cursor mActivityCursor) {
		...
		this.startDate = mActivityCursor
				.getString(mActivityCursor
		...
		this.eventDrawableResId = mActivityCursor
				.getInt(mActivityCursor
						.getColumnIndex(ActivityCalendarTableHelper.ACTIVITY_EVENT_DRAW_ID));
		this.session_id = mActivityCursor
				.getInt(mActivityCursor
